...
**NOTE:** This is for developers! If you want to set up your own private server quickly and without writing any code, check out [ZRPS-Template](https://github.com/JamzOhJamz/ZRPS-Template).
